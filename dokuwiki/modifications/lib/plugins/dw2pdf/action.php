...
class action_plugin_dw2pdf extends DokuWiki_Action_Plugin {
    ...
    protected function load_template($title){
		...
		//<span class="bchead"> </span><span class="home"><bdi><a href="/start" class="wikilink1" title="start">Infrabel</a></bdi></span> Â» <bdi><a href="/cc/start" class="wikilink1" title="cc:start">Competence Centers</a></bdi> Â» <bdi><a href="/cc/ndcc/start" class="wikilink1" title="cc:ndcc:start">.NET Development Competence Center</a></bdi> Â» <bdi><span class="curid"><a href="/cc/ndcc/newsletters/start" class="wikilink1" title="cc:ndcc:newsletters:start">Newsletters</a></span></bdi>
		ob_start();
		tpl_youarehere();
		$breadcrumb = ob_get_clean();
		$breadcrumb = str_replace($lang['youarehere'] . ':', '', $breadcrumb);
		$breadcrumb = str_replace('href="/', 'href="' . DOKU_URL, $breadcrumb);
