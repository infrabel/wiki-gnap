...
class syntax_plugin_bureaucracy_action_template extends syntax_plugin_bureaucracy_action {
    ...
    function buildThankYouPage($thanks) {
		...
		$ret .= '<script>jQuery(function() { jQuery(\'a.folder[href*="#\' + jQuery(\'#scroll__here\').closest(\'.folded\').attr(\'id\') + \'"]\').click(); });</script>';
		//$ret .= '<script>jQuery(function() { location.reload(); });</script>';
        return $ret;
    }
